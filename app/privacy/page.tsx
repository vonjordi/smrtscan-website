  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-content">
        <p>
          This Privacy Policy explains how 1001474709 Ontario Inc. operating as SMRTscan ("we," "us," or "our")
          collects, uses, and shares information when you use the SMRTscan mobile application and related services
          (the "Service").
        </p>
        <p>If you do not agree with this policy, do not use the Service.</p>
        ...
        <p>
          ...
          <strong>We do not collect or store your payment card details.</strong> We receive only subscription
          status and entitlement data from our subscription management provider (RevenueCat).
        </p>

        <h3>1.4 Cloud Backups (Optional)</h3>
        <p>
          If you enable cloud backup, receipt images and data may be uploaded to your connected cloud provider
          (iCloud or Google Drive). <strong>You control whether this is enabled</strong>, and backups are stored
          in your personal cloud account—not on our servers.
        </p>

        <h3>1.5 AI Processing</h3>
        <p>
          When you scan receipts, images are sent to Anthropic's Claude API for text extraction.
        ...
        <ul>
          <li><strong>Market research:</strong> Anonymized spending trends and patterns (e.g., "X% of users in Ontario shop at grocery stores on weekends")</li>
        ...
        <ul>
          ...
          <li>Your location beyond general region (e.g., province/state level only)</li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li><strong>Deleted items:</strong> Moved to "Recently Deleted" for 30 days, then permanently removed.</li>
        ...
        <h2>11. Contact Us</h2>
        <p>
          If you have questions about this Privacy Policy, wish to exercise your privacy rights, or need to report
          a concern, contact us at:
        </p>
        <p>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>Receipt scans & data</td>
              <td>Process and organize</td>
              <td>Delete anytime</td>
            </tr>
            <tr>
              <td>Mileage trips</td>
              <td>Track business travel</td>
              <td>Full control</td>
            </tr>
            <tr>
              <td>Usage data</td>
              <td>Improve the app</td>
              <td>N/A (anonymized)</td>
            </tr>
            <tr>
              <td>Device info</td>
